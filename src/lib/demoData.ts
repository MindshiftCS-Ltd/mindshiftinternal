...
export const demoStaff: DemoStaff[] = [
  { id: 'MS-STAFF-0001', name: 'Gift Akerele', email: 'giftakerele1@gmail.com', department: 'Executive / Management', role: 'Super Admin', status: 'Active' },
  { id: 'MS-STAFF-0002', name: 'Ada Nwosu', email: 'ada.n@mindshift.com', department: 'Human Resources', role: 'HR Admin', status: 'Active' },
  { id: 'MS-STAFF-0003', name: 'Chuka Obi', email: 'chuka.o@mindshift.com', department: 'Finance & Accounts', role: 'Finance Admin', status: 'Active' },
  { id: 'MS-STAFF-0004', name: 'Dara Akerele', email: 'dara.a@mindshift.com', department: 'Operations & Projects', role: 'Department Officer', status: 'Active' },
  { id: 'MS-STAFF-0005', name: 'Precious O.', email: 'precious.o@mindshift.com', department: 'Operations & Projects', role: 'Project Manager', status: 'Probation' },
]
...
export const demoAuditLog: DemoAuditEntry[] = [
  { id: 'a1', actor: 'Ada Nwosu', action: 'Changed Staff Status', entity: 'STAFF-026', before: 'Probation', after: 'Confirmed', when: '07 Sept 2026 · 14:32' },
  { id: 'a2', actor: 'Chuka Obi', action: 'Approved Payment', entity: 'INV-2291', before: 'Pending', after: 'Approved', when: '07 Sept 2026 · 11:05' },
  { id: 'a3', actor: 'Gift Akerele', action: 'Created Department', entity: 'Technology & Innovation', when: '06 Sept 2026 · 16:40' },
  { id: 'a4', actor: 'Dara Akerele', action: 'Submitted Leave Request', entity: 'LR-0042', when: '05 Sept 2026 · 09:12' },
]

export const demoTasks = [
  { id: 't1', title: 'Review Q3 leave requests', department: 'HR', due: 'Today', priority: 'high' as const },
  { id: 't2', title: 'Approve vendor payment #INV-2291', department: 'Finance', due: 'Today', priority: 'urgent' as const },
  { id: 't3', title: 'Follow up with ABC Consulting', department: 'Business Development', due: 'Tomorrow', priority: 'normal' as const },
]
